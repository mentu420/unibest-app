...
import qs from 'qs'
import { ref } from 'vue'
import { EmptyCard } from '@/components/list-load/'
...
<template>
      ...
      <view>
        ...
        <view v-else>
          <view v-if="tabsList.length > 0" @click="goSearch">
            <wd-search placeholder="请输入搜索关键词" hide-cancel disabled></wd-search>
          </view>
              ...
              <view class="w-screen pt-2">
                ...
                >
                  <swiper-item v-for="(item, i) in bannerList[n]" :key="i">
                    ...
                    >
                      <WdImage class="h-[159px] w-full" mode="aspectFill" :src="item.imgUrl" />
                    </view>
                  </swiper-item>
                </swiper>
                    ...
                    <view class="inline-grid grid-cols-2 gap-2">
                      ...
                      >
                        <view class="h-[130px] w-full overflow-hidden rounded-md">
                          <WdImage class="h-[130px] w-full" mode="aspectFill" :src="item.image" />
                        </view>
            ...
            <view v-for="item in trainList" :key="item.id" class="mx-4" @click="goLiveDetail(item)">
              <view>
                <view class="h-[180px] w-full overflow-hidden rounded-md">
                  <WdImage class="h-[180px] w-full" mode="aspectFill" :src="item.roomPhoto" />
                </view>
                <view class="p-2">
                  <text>{{ item.title }}</text>
                  <view class="text-sm text-theme-yellow">
                    ...
                    <span v-if="item.password !== ''" class="i-uil-lock-alt"></span>
            ...
            <view class="grid grid-cols-2 gap-4 px-4 pb-4">
              ...
              >
                <view class="h-full w-full overflow-hidden rounded-md">
                  <WdImage class="h-full w-full" mode="aspectFill" :src="trainItem.roomPhoto" />
                </view>
                <view class="p-2" style="width: 310rpx">
                  ...
                  <view v-if="trainItem.paymentFlag === 1">
                    ...
                    <view v-if="trainItem.userPaymentFlag" class="text-xs px-2 py-1 bg-red-500">
                      已付款
                    </view>
                  </view>
                </view>
  ...
  <wd-popup v-model="showNotice" position="center" closable lockScroll>
